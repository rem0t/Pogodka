...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.cellLabel.text = [NSString stringWithFormat:@"min %li°/max %li°", (long)roundf([self.weatherForcast.arrayWithWeater[indexPath.row][@"temp"][@"min"] floatValue]),(long)roundf([self.weatherForcast.arrayWithWeater[indexPath.row][@"temp"][@"max"] floatValue])];
...
- (void)updateLabele {
    ...
    self.iboCurrentTemperature.text =  [NSString stringWithFormat:@" %d°", [[[[self.weatherForcast.arrayWithWeater
                                                                             valueForKey:@"temp" ]
                                                                             valueForKey:@"day"] firstObject] intValue]]; // температура
